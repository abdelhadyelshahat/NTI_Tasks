 ...
 * 				 =>Copy_u8Direction   Options: DIO_u8_PIN_OUTPUT_DIRECTION, DIO_u8_PIN_INPUT_DIRECTION  	                             	    																**/
 /* Return type :(u8 variable)        STD_TYPES_NOK State  (STD_TYPES_NOK, STD_TYPES_OK)
...
{
	/* STD_TYPES_NOK State variable  */
	u8 Local_u8STD_TYPES_NOKState = STD_TYPES_NOK ;
	...
	{
		Local_u8STD_TYPES_NOKState = STD_TYPES_OK;
		...
		{
			 Local_u8STD_TYPES_NOKState = STD_TYPES_NOK ;
		}

	}


	return Local_u8STD_TYPES_NOKState;
}
...
u8 M_DIO_u8_ActivePullupResistor (u8 Copy_u8PortNumber ,u8 Copy_u8PinNumber , u8 Copy_u8State)
{
	...
	if (Copy_u8PortNumber <  DIO_u8_PORTD && Copy_u8PinNumber < DIO_u8_PIN7 )
	{
		...
		else { Local_u8STD_TYPES_NOKState = STD_TYPES_NOK ;	}
